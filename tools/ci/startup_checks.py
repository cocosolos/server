...
ci_dir_path = os.path.normpath(os.path.dirname(os.path.abspath(__file__)))
tools_dir_path = os.path.normpath(os.path.dirname(os.path.abspath(ci_dir_path)))
server_dir_path = os.path.normpath(os.path.dirname(os.path.abspath(tools_dir_path)))


def from_tools_path(path):
    return os.path.normpath(os.path.join(tools_dir_path, path))
...
def populate_tests():
    test_list = []
    for file in sorted(os.scandir(from_tools_path("ci/tests")), key=lambda e: e.name):
